...
public class MySnakePanel extends JPanel{
    ...
    protected void paintComponent(Graphics g){
        ...
        if(!isLose){
            ...
            g.setColor(Color.green);
            Font f = new Font("Book Antiqua", Font.PLAIN, 30);
            g.setFont(f);
            char [] a = {'N', 'a', 'm', ' ',':','1','0','0'};
            g.drawChars(a, 0, a.length, MyStaticVar.X + 30, 150);
            
            g.setColor(Color.green);
            Font fa = new Font("Book Antiqua", Font.PLAIN, 30);
            g.setFont(f);
            char [] b = {'T', 'h', 'a', 'i', ' ', ' ',':','9','3'};
            g.drawChars(b, 0, b.length, MyStaticVar.X + 30, 200);
            
            g.setColor(Color.green);
            Font fb = new Font("Book Antiqua", Font.PLAIN, 30);
            g.setFont(f);
            char [] c = {'T', 'h', 'a','o', ' ', ' ', ' ',':','9','3',};
            g.drawChars(c, 0, c.length, MyStaticVar.X + 30, 250);
